      ...
      <div id="contact">
        ...
        <div className="container">
            ...
            <div className="row control-group text-center">
              <div className="form-group col-md-4 col-md-offset-4 floating-label-form-group controls input-group">
                <span className="fonty input-group-addon"> Pin Tag #:</span>
                  <input type="text" maxLength='4' className="" placeholder="####" id="name" ref='PIN'/>
              </div>
            </div>  

            <div className="row control-group text-center">
              <div className="form-group col-md-4 col-md-4 col-md-offset-4 floating-label-form-group controls input-group">
                <span className="fonty input-group-addon text-center">Amount:  $</span>
                  <input type="text" onChange={this.handleChange} className="" placeholder="0.00" id="" ref='amount'/>
              </div>
            </div> 
            </div>
